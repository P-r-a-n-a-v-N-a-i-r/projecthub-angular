...
describe('DashboardComponent', () => {
  ...
  it('should handle backward compatible stats response', () => {
    ...
    expect(component.stats.completionRate).toBe(62.5); // Uses legacy completionRate
  });
  ...
  it('should use partial values with null fields', () => {
    ...
    expect(component.stats.activeProjects).toBe(0); // null → 0
    expect(component.stats.activeTasks).toBe(7);
    expect(component.stats.completionRate).toBe(0); // null → 0
  });
